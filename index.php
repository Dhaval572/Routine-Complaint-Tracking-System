            ...
            <div class="col-md-8 col-lg-6">
                <div class="card login-card">
                    ...
                    <div class="login-options">
                        <a href="user/user_login.php" class="btn btn-success login-btn">
                            <i class="fas fa-user"></i> User Login
                        </a>

                        <a href="officer/officer_login.php" class="btn btn-primary login-btn">
                            <i class="fas fa-briefcase"></i> Officer Login
                        </a>

                        <a href="depthead/dept_head_login.php" class="btn btn-warning login-btn">
                            <i class="fas fa-building"></i> Department Head Login
                        </a>

                        <a href="admin/admin_login.php" class="btn btn-danger login-btn">

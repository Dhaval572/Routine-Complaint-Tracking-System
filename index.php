        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 text-center text-lg-left">
                    ...
                    <p class="lead mb-4">Efficiently manage and track complaints with our comprehensive system. We
                        provide a streamlined solution for handling citizen complaints and ensuring timely resolutions.
                    </p>
    ...
    <div class="container py-5">
        ...
        <div class="row mb-5">
            <div class="col-lg-6 mb-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <h3 class="mb-4"><i class="fas fa-star text-warning mr-2"></i>Key Features</h3>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card border-0 shadow-sm h-100 bg-primary text-white">
                    <div class="card-body p-4">
                        <h3 class="mb-4"><i class="fas fa-users mr-2"></i>User Benefits</h3>

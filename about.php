            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    <div class="col-md-3 text-center mb-4">
                        ...
                        <h5>Citizens</h5>
                        <p class="small text-muted">Submit and track complaints</p>
                    </div>
                    <div class="col-md-3 text-center mb-4">
                        ...
                        <h5>Officers</h5>
                        <p class="small text-muted">Handle assigned complaints</p>
                    </div>
                    <div class="col-md-3 text-center mb-4">
                        ...
                        <p class="small text-muted">Oversee department operations</p>
                    </div>
                    <div class="col-md-3 text-center mb-4">
                        ...
                        <p class="small text-muted">System management</p>
                    </div>
                </div>
            </div>
        </div>

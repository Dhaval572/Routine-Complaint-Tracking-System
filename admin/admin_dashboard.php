    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-primary text-white"
          onclick="location.href='create_department.php';" style="cursor: pointer;">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-success text-white"
          onclick="location.href='view_departments.php';" style="cursor: pointer;">
          <div class="card-body text-center p-4">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-warning text-white"
          onclick="location.href='create_dept_head.php';" style="cursor: pointer;">
          <div class="card-body text-center p-4">
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-danger text-white"
          onclick="location.href='view_dept_heads.php';" style="cursor: pointer;">
          <div class="card-body text-center p-4">
      ...
      <!-- Card: Create Officer -->
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-info text-white" onclick="location.href='create_officer.php';"
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 border-0 shadow rounded bg-secondary text-white"
          onclick="location.href='view_officers.php';" style="cursor: pointer;">
          <div class="card-body text-center p-4">

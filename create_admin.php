                    ...
                    <form method="POST" action="">
                        <div class="form-group mb-3">
                            <div class="input-group shadow-sm">
                                ...
                                <input type="text" name="name" required class="form-control bg-white border-left-0 rounded-pill py-2 pl-2" placeholder="Full name">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="input-group shadow-sm">
                                ...
                                <input type="email" name="email" required class="form-control bg-white border-left-0 rounded-pill py-2 pl-2" placeholder="Email address">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="input-group shadow-sm">
                                ...
                                <input type="password" name="password" required class="form-control bg-white border-left-0 rounded-pill py-2 pl-2" placeholder="Create strong password">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="input-group shadow-sm">
                        ...
                        <button type="submit" name="register" class="btn btn-dark btn-block mb-3 shadow-lg rounded-pill py-2 font-weight-bold">
                            <i class="fas fa-plus-circle mr-2"></i>Create Account
                        </button>
                        <div class="text-center">
                            <a href="admin/admin_login.php" class="text-dark small">

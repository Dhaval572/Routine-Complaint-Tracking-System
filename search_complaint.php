...
<head>
	...
	<style>
		body {
			min-height: 100vh;
			background: linear-gradient(135deg, #1a3a8f 0%, #0d2b6b 100%);
		}
				...
				">
					...
					">
						<div class="d-flex align-items-center">
							<a href="index.php" class="text-white" style="font-size: 1.2rem;">
								<i class="fas fa-arrow-left"></i>
							</a>

							<h4 class="mb-0 text-white font-weight-bold mx-3"
								style="text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2);">
								Track Your Complaint</h4>
						</div>
					</div>
					...
					<div class="card-body p-md-5 p-4"
						...
						<form method="GET" action="" class="mb-4">
							<div class="form-group p-4 rounded-lg"
								style="background: rgba(255, 255, 255, 0.7); border: 1px solid rgba(41, 98, 255, 0.1); box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05);">
								<label class="font-weight-bold text-primary">
									<i class="fas fa-hashtag mr-2">Enter Complaint ID</i>
								</label>
						...
						<?php if (!isset($_GET['complaint_id'])) { ?>
							<div class="text-center py-5 my-3 rounded-lg" style="
								...
								<div class="mb-4 mx-auto rounded-circle d-flex align-items-center justify-content-center"
									style="
									width: 100px; 
									height: 100px; 
									background: linear-gradient(135deg, #2962ff 0%, #1565c0 100%); 
								...
								<h4 class="text-primary mb-3 font-weight-bold">Enter Complaint ID to Search</h4>
								<p class="text-muted mb-4 px-4 mx-auto" style="max-width: 600px;">Please enter your
									complaint ID in the form above to track its current status and progress.</p>
								<div class="alert alert-info mx-auto mb-0"
									style="max-width: 500px; background: rgba(41, 98, 255, 0.05); border: 1px solid rgba(41, 98, 255, 0.1);">
									<div class="d-flex align-items-center">
										<i class="fas fa-info-circle text-primary mr-3" style="font-size: 1.5rem;"></i>
										<p class="mb-0">You can find your complaint ID in the confirmation email or SMS you
											received when registering the complaint.</p>
									</div>
								</div>
							</div>
						<?php } ?>
						...
						<?php if (isset($error)) { ?>
							<div class="text-center py-5 my-3" style="background: linear-gradient(135deg, rgba(220, 53, 69, 0.15), rgba(240, 62, 78, 0.25)); 
								border-radius: 20px; 
